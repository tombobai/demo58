    ...
    public function handle()
    {
        ...
        $vars = [
            ...
            "tables"      => [
                ...
                //"Server/Request Data"   => $this->masked($_SERVER, '_SERVER'),//tombo delete 为了防止报错时，把服务器信息打印出来
                //"Environment Variables" => $this->masked($_ENV, '_ENV'),//tombo delete 为了防止报错时，把服务器信息打印出来
            ],
        ];
